...
//log.debug("ddd n="+n);
  ...
  public CToken getBOSToken() throws IOException {
    ...
    t.read(tfd);
/*
    log.info("getBOSToken()");
    log.info("rcAttr2 = " + t.rcAttr2);
    log.info("rcAttr1 = " + t.rcAttr1);
    log.info("lcAttr = " + t.lcAttr);
    log.info("posid = " + t.posid);
